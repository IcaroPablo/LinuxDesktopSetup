...
export PATH="/opt/gradle/gradle-7.1.1/bin:$PATH"
export PATH="/opt/maven/apache-maven-3.8.1/bin:$PATH"

# maven home (intellij setup)
export M2_HOME="/opt/maven/apache-maven-3.8.1/bin"

# to avoid window malfunctioning with java applications
...
alias maidavpn2='cat ~/Maida/maidavpnpw.txt | xclip -i -se c && sudo openvpn Maida/jarvis-UDP4-1398-icaro.andrade-config.ovpn'
